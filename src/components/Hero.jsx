...
const Hero = () => {
  return (
    <div className='flex flex-wrap md:flex-nowrap gap-x-10 lg:gap-x-20 cursor-pointer'>
      <img alt="Home Image" src={homeImg} className='animate__animated animate__backInLeft animate__delay-.5s  mx-auto w-auto h-[680px]  md:pl-[100px] xl:pl-[200px] mt-[-200px]' />
      <div className='animate__animated animate__backInRight animate__delay-.5s flex flex-col px-5 md:px-0 pt-16'>
