...
const Discount = () => {
  return (
    <div  data-aos="fade-down" className='cursor-pointer flex flex-wrap sm:flex-nowrap items-center gap-x-10 mx-5 sm:mx-20 xl:mx-[250px] py-10 px-5 sm:px-[50px] bg-[#181A1B] my-[100px] rounded-2xl  '>
      <div>
